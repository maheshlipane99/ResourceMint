    ...
    render() {
        return (
            <TouchableRipple
                ...
                onPress={!this.props.item.isDisable ? () => this.props.onPress('rootView') : null}
                    ...
                    <View style={{ flexDirection: 'row', padding: 10 }}>
                        ...
                        <TouchableRipple style={styles.container} >
                            <View>
                                ...
                                <Text style={styles.textLabel}>Role :   <Text style={[styles.textContent]}>{this.props.item.userRole}</Text></Text>
                                <Text style={styles.textLabel}>Department :  <Text style={[styles.textContent]}>{this.props.item.departmentTitle}</Text></Text>
                            </View>
                        </TouchableRipple>
                        <Icon
                            name={this.props.item.isChecked ? 'check-square' : 'square'}
                            style={{ color: this.props.item.isChecked ? '#6C63FF' : "gray", fontSize: 20, marginRight: 0 }}
                            type={'FontAwesome'}
                        />
                    </View>
                </View>
