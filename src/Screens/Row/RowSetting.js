            ...
            btn = (
                <View style={{ flex: 1, paddingRight: 10, alignSelf: 'flex-start', marginBottom: 10 }}>
                    <Button
                        ...
                        style={{}}
                        contentStyle={{}}
                        onPress={() => { this.props.onPress(this.props.item.count > 0 ? 'reload' : 'download') }} > {this.props.item.count > 0 ? 'Reload' : 'Download'} </Button>
                </View>
            )
        }
        return (
                ...
                <Card style={{ backgroundColor: 'white', radius: 10 }} elevation={5}>
                    <View onPress={() => this.props.onPress('rootView')} style={{ flexDirection: 'row', flex: 1, padding: 0 }}>
                        <View style={{ backgroundColor: 'white', padding: 5, margin: 5 }}>
                            <Image source={this.props.item.icon} style={styles.backImage} tintColor="#0A8BCC" />
                        </View>
