...
class TaskDetail extends Component {
    ...
    getServerData = () => {
        BackgroundService.getTaskDetails(this.state.mToken, this.state.serverId, this.state.complaintId).then((result) => {
            ...
            btn = (
                <View style={{ padding: 10 }}>
                    <Button
                        ...
                        loading={this.state.animating}
                        contentStyle={{ height: 50 }}
                        onPress={() => { this.onClickHandler('cancel') }}  >Cancel Task</Button>
                </View>
            ...
            masterView = (
                <View style={styles.container}>
                    <ScrollView style={{ flex: 1 }}
                        ...
                        {this.state.data.complaintImages.length > 0
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View>
                    <ConfirmDialog
                        title="Cancel"
                        message="Are you sure to cancel task?"
...
export default connect(mapStateToProps, { dataChanged })(TaskDetail);
